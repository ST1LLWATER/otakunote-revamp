...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col mt-16 my-6">
        <h1 className="text-center text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-5xl dark:text-white">
          Trending
        </h1>
